import numpy as np
from two_layer_functions_clean import init2, sim2, train_with_stop_without_adaptive, train_with_adaptive_without_momentum, train_with_adaptive_with_momentum
